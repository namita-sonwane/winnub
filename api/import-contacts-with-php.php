...
<html lang="EN">
<head>
	<title>Google API import contacts</title>
...
$google_client_id = '958786882496-r5rnk5ej1ovl1jhf90imjeo71ng8mvi4.apps.googleusercontent.com';
$google_client_secret = '8m5ZklcNmf-HnsEKou4eMy3h';
$google_redirect_uri = 'http://web.winnub.com/api/import-contacts-with-php.php';



//setup new google client
$client = new Google_Client();
$client -> setApplicationName('Google contact');
...
<div class="container">
	<div class="row">
		...
		<div class="col-lg-12">
			...
			<a class="btn btn-primary" href="<?php echo $googleImportUrl; ?>" role="button">Get gmail contacts</a>
