...
$config['language_abbr']= substr($_SERVER['HTTP_ACCEPT_LANGUAGE'],0, 2);

/* set available language abbreviations */
$config['lang_uri_abbr'] = array("it" => "italian", "en" => "english");
...
|
*/
$config['encryption_key'] = 'xmasd2sds';
...
$config['cookie_domain']	= 'web.winnub.com';
$config['cookie_path']		= '/';
